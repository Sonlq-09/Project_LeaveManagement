...
/**
 * Lớp UserDBContext quản lý các thao tác CRUD (Create, Read, Update, Delete)
 * với bảng Users trong database.
 */
public class UserDBContext extends DBContext<User> {
    ...
    /**
     * Đóng các tài nguyên database (Connection, PreparedStatement, ResultSet) để tránh rò rỉ.
