<%-- 
    Document   : manage-leave
    Created on : Mar 16, 2025, 4:39:15 PM
    Author     : LTSon
--%>
...
<% 
    if (session.getAttribute("user_id") == null || !"manager".equalsIgnoreCase((String) session.getAttribute("role"))) {
    ...
    try {
        ...
        System.out.println("Error fetching leaves in manage-leave.jsp: " + e.getMessage());
    }
%>
<!DOCTYPE html>
<html lang="vi">
...
<body>
    <div class="container">
        ...
        <h2>Kiểm tra đơn xin nghỉ phép</h2>
        <table>
            <tr>
                <th>Tên nhân viên</th>
                <th>Loại nghỉ</th>
                ...
                <tr>
                    ...
                    <td class="action-buttons">
                        <% if ("Pending".equals(leave.getStatus())) { %>
                            <form action="manage-leave" method="post">
            ...
            <% if (employeeLeaves.isEmpty()) { %>
                <tr><td colspan="6">Chưa có đơn nào từ nhân viên.</td></tr>
            <% } %>
        </table>
